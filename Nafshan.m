...
data_dir = 'D:\DSP Project';
export_dir = 'D:\DSP Project';
% --- Loading ALL Heart Sound Files ---
heart_sounds_folder = fullfile(data_dir, 'Heart_Data');
...
lung_sounds_folder = fullfile(data_dir, 'Lung_Data');
...
lung_annotations_master_path = fullfile(data_dir, 'lung_annotations_master.csv'); 
